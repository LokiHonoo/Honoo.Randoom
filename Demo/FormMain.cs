...
namespace Demo
{
    public partial class FormMain : Form
    {
        ...
        private void ButtonMarkDescription_Click(object sender, EventArgs e)
        {
            ...
            description.AppendLine("'a' 英文字母，不包括字形易混淆的字符。");
            description.AppendLine("'A' 英文字母。");
            description.AppendLine("'m' 英文字母和阿拉伯数字，不包括字形易混淆的字符。");
            description.AppendLine("'M' 英文字母和阿拉伯数字。");
            description.AppendLine("'h' 十六进制字符。");
        ...
        private void FormMain_Load(object sender, EventArgs e)
        {
            ...
            this.ComboBoxToken.Items.Add("'a' 英文字母，不包括字形易混淆的字符。");
            this.ComboBoxToken.Items.Add("'A' 英文字母。");
            this.ComboBoxToken.Items.Add("'m' 英文字母和阿拉伯数字，不包括字形易混淆的字符。");
